    ...
    <div >
      <div   className='grid sm:grid-cols-5 grid-cols-3 gap-5'>
        ...
        <div className='flex justify-center items-center sm:gap-5 gap-1'>
          ...
          <p className="whitespace-pre-wrap text-sm sm:text-3xl font-bold text-blue-400">
                <FlipNumbers
                  height={35}
                  width={20}
        ...
        <div className='flex justify-center items-center gap-1 sm:gap-5'>
            ...
            <p className="whitespace-pre-wrap text-sm sm:text-3xl flex justify-end items-end font-bold text-red-600   ">
              <FlipNumbers
                height={35}
                width={20}
                color="red" // Adjust as needed
